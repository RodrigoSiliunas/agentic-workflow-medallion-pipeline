...
from pipeline_lib.agent.observer.providers.base import DiagnosisResult
...
class TestNormalizedFixes:
    ...
    def test_multi_file_preferred_over_singular(self):
        ...
        result = DiagnosisResult(
            ...
            file_to_fix="a.py",
            fixes=[
                {"file_path": "pipeline_lib/schema/contracts.py", "code": "X"},
        ...
        assert [f["file_path"] for f in fixes] == [
            "pipeline_lib/schema/contracts.py",
...
class TestGitHubProviderValidation:
    def test_create_fix_pr_rejects_empty_diagnosis(self):
        ...
        from pipeline_lib.agent.observer.providers.github_provider import GitHubProvider
