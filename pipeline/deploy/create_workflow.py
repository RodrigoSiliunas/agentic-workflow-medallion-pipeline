...
Notas:
  - Roda em serverless compute (unico suportado no workspace)
  - Acesso ao S3 via boto3 + Databricks Secrets (scope por tenant)
  - Dados persistem no S3 (lake) E no Unity Catalog (queries)
"""
...
def create_workflow():
    ...
    # ============================================================
    # DEFINIR TASKS DO WORKFLOW (serverless compute)
    # ============================================================
    tasks = [
    ...
    print("  S3 access: boto3 via Databricks Secrets (scope: medallion-pipeline)")
