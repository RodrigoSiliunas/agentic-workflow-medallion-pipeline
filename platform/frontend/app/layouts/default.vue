<template>
  <div class="flex h-screen" style="background: var(--bg-primary); color: var(--text-primary)">
    <!-- Sidebar -->
    <aside
      class="w-[280px] flex-shrink-0 flex flex-col border-r overflow-y-auto"
    ...
    >
      ...
      <!-- Sidebar content (pipelines + threads) -->
      ...
      <div class="p-4 border-t" style="border-color: var(--border-default)">
        <div class="flex items-center gap-2">
          ...
          <UButton variant="ghost" icon="i-heroicons-cog-6-tooth" size="xs" @click="navigateTo('/settings')" />
        </div>
      </div>
    </aside>
